...
\newcommand{\vInj}[2]{\keyword{inj}_{#1}(#2)}
\newcommand{\vThunk}[1]{\keyword{thunk}(#1)}
...
\newcommand{\eRd}[1]{\textsf{rd}(#1)}
\newcommand{\eWr}[2]{\textsf{wr}(#1<-#2)}
\newcommand{\eNu}[2]{\nu#1.\,#2}
...
\newcommand{\vChan}[1]{\texttt{chan}(#1)}
